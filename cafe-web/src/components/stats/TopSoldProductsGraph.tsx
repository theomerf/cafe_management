...
type TopSoldProductsGraphProps = {
    topSoldStats: ProductStats[] | undefined
    isLoading: boolean
    error: Error | null
}

export default function TopSoldProductsGraph({ topSoldStats, isLoading, error }: TopSoldProductsGraphProps) {
